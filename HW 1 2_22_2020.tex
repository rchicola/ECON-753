...
\begin{equation}
Unconditional [Child;Post]:  \widehat{work_{i,t}}= 0.575 + 0.0469 * (1) - 0.129 (1) - 0.00207 * (1) = 0.49083‬
\end{equation}

\begin{equation}
Unconditional [Child;Pre]:  \widehat{work_{i,t}}= 0.575 + 0.0469 * (0) - 0.129 (1) - 0.00207 * (0) =  0.446
\end{equation}

\begin{equation}
Unconditional [NoChild;Post]:  \widehat{work_{i,t}}= 0.575 + 0.0469 * (0) - 0.129 (0) - 0.00207 * (1) = 0.57293207
\end{equation}

\begin{equation}
Unconditional [NoChild;Pre]:  \widehat{work_{i,t}}= 0.575 + 0.0469 * (0) - 0.129 (0) - 0.00207 * (0) = 0.575
\end{equation}
...
\begin{multline}
Conditional : work_{i,t}= 0.496 + 0.0495* KidPost_{i,t} - .118* Child_{i,t} -.0234* Post1993  \\
-0.0164* urate - 0.0445* nonwhite + 0.00195 age + 0.0171 ed +     \epsilon_{i,t} 
\end{multline}
